...
import { CopyCode } from '@/app/_components/copy-code';
...
export function CodeBlockElementStatic({
  ...
  return (
    <SlateElement
      ...
      {...props}
    >
      {/* The reader's own affordances: what language this is, and a way to take it. */}
      <div className="pf-prose-code-actions" contentEditable={false}>
        {showLanguageLabel && languageLabel && (
          <span className="pf-prose-lang">{languageLabel}</span>
        )}
        <CopyCode text={NodeApi.string(props.element)} />
      </div>
