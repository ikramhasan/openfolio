...
const editorContainerVariants = cva(
  'relative w-full cursor-text select-text overflow-y-auto caret-primary focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border',
  {
    defaultVariants: {
      variant: 'default',
    },
